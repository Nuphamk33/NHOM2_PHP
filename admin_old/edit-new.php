        ...
        <div class="mx-5 my-5 card w-100">
            ...
            <?php
              ...
              if (isset($_POST['update'])) {
                if (isset($_POST['news_id']) &&  isset($_POST['title']) && isset($_POST['name']) && isset($_POST['content_tag']) && isset($_POST['image'])&& isset($_POST['summary'])&& isset($_POST['content'])) {
                  if (!empty($_POST['news_id']) &&  !empty($_POST['title']) && !empty($_POST['name']) && !empty($_POST['content_tag']) && !empty($_POST['image']) && !empty($_POST['summary']) && !empty($_POST['content'])) {
            ...
            //         header("Location: edit-new.php?id=$id");
            //       }
            //     }
            //   }
          ?>
          ...
          <div class="form-group">
            ...
            <textarea type="text" class="form-control" id="description" name="summary" rows="3" required><?php echo $row['summary'] ?></textarea>
            <div class="invalid-feedback">
             Vui lòng không để trống</div>
             <div class="form-group">
            <label for="">Nội dung</label>
            <textarea type="text" class="form-control" id="content" name="content" rows="3" required><?php echo $row['content'] ?></textarea>
            <div class="invalid-feedback">
             Vui lòng không để trống</div></div>
     
                        <!-- <div class="col-md-12 mb-3">
                            <label for="content">Nội dung</label>
                            <textarea type="text" class="form-control" id="content" name="content" required><?php echo $row['content'] ?></textarea>
                            <div class="invalid-feedback">
                                Vui lòng không để trống trường này
                            </div>
                        </div> -->
                    <!-- <div class="form-group">
                    <button type="submit" name="update" class="btn btn-primary" style="color: white; font-weight: bold;">Lưu Lại</button>
                    </div>
                    <a class="btn btn-cancel" data-dismiss="modal" href="table-data-new.php" style="background-color: rgb(255 197 197);
