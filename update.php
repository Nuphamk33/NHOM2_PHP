...
<body>
 ...
 <!-- Header End -->
        ...
        <div class="col-lg-12 col-xl-7 align-self-center order-2 order-xl-1">
          <div class="sign-in-content h-100">
            <div class="section-title text-center">
              <h2 class="primary-text">Chỉnh sửa thông tin tài khoản</h2>
            </div>
            ...
            <form class="row mt-4 mb-4 mb-sm-5 align-items-center form-flat-style" action="php/update.php" method="post">
              ...
              <div class="col-sm-5 d-grid">
                <button type="submit" class="btn btn-primary btn-flat">Lưu thông tin</button>
  ...
  <!--=================================
   ...
   Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Quynhh</a>
